...
import { loginStyles } from "../assets/datastyle";
import { Link, useNavigate } from "react-router-dom";
import { ArrowLeft, EyeOff, Eye, Lock, Mail } from "lucide-react";
                          ...
                          <div className={loginStyles.signupContainer}>
                              <div className={loginStyles.signupContent}>
                                <span className={loginStyles.signupText}>
                                  ...
                                  <Link to="/signup" className={loginStyles.signupLink}>   Create Accoumt</Link>
